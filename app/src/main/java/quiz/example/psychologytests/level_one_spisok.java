...
public class level_one_spisok extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(level_one_spisok.this,MainActivity.class);
        ...
        honesty_test.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(level_one_spisok.this, honesty_tests.class);
                startActivity(intent);
                finish();
            }
        });
